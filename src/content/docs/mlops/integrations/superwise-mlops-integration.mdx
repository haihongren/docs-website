...
2.  **Click on Superwise:** In the search bar, type **Superwise**.
3.  **Select an account ID:** Select the account ID you want Superwise to integrate with.
4.  **Create two access tokens:**
    -   Once you select an Account ID, you'll see the New Relic Integration screen. Under **Model Metrics Data**, click **Create a key**. This generates a <InlinePopover type="licenseKey" />.
